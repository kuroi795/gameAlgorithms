...
class EuclideanDistanceTest
{
    ...
    void evaluate_givenSameLocation_returnZero()
    {
        ...
        double evaluation = euclideanDistance.evaluate( location, location );
    ...
    void evaluate_givenIncorrectLocation_returnMinusOne()
    {
        ...
        double evaluation = euclideanDistance.evaluate( source, goal );
    ...
    void evaluate_givenProperLocations_returnDistance()
    {
        ...
        double evaluation = euclideanDistance.evaluate( source, goal );
        assertEquals( 2.828, evaluation, 0.001 );
    }
}
